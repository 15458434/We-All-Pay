...
class TodayViewController: UIViewController, NCWidgetProviding {
        ...
        if let validValue = valid {
            if validValue == true {
                ...
                if finalString.count > 0 {
                    ...
                    NCWidgetController().setHasContent(true, forWidgetWithBundleIdentifier: WhoPayingUserDefaultsStoreInterface.MCWhoIsPayingNextBundleIdentifier)
                } else {
    ...
    @objc func defaultsDidUpdate(_ notification: Notification) {
    ...
    @objc func tappedInTheBackground(_ sender: AnyObject) {

...
@objc(MCEmailAddress) public final class MCEmailAddress: NSManagedObject {
    ...
    public override func awakeFromInsert() {
        ...
        self.setPrimitiveValue(UUID().uuidString, forKey: #keyPath(MCEmailAddress.uniqueEmailId))
        let now = Date()

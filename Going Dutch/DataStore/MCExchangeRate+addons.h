...
- (BOOL)retrieveExchangeRateFromWeb __deprecated;
- (BOOL)retrieveExchangeRateFromWebWithCompletionHandler:(void (^)(NSDictionary *exchangeRateResult))completionBlock __deprecated;

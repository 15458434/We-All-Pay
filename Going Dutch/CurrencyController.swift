...
public class Currency: NSObject {
    ...
    public var symbol: String {
        return Locale.current.displayName(forKey: Locale.Key.currencySymbol, value: code) ?? ""
    }
...
public class CurrencyController: NSObject {
    ...
    public override init() {
        let currencyFilePath = Bundle(identifier: "com.GreenHair.CurrencyConverter")!.pathForResource("Available Currencies", ofType: "plist")
